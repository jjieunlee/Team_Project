                            	...
                            	console.log("i"+i);
                            	 for (let j = 0; j < listEl.length; j++) {
                                     ...
                                     if(j==(listEl.length)-1){
                                    	 ...
                                    	 //if in
                                    	 console.log("if in i"+i);
                                    	 console.log("if in j"+j);
                                     }
                            	 }
                                 //message += "</ol>";
                                 //message += "<br>";
                                 $("#sel").append(message);
                                 //final log
                                 console.log("final"+listEl.length);
                                 console.log(index);
                            }
                            //message += "<li>" + "의료기관명:"+의료기관명 +"<br>"+" 주소:"+주소 + "</li>";
                        }
            ...
            <h5 class="card-title">코로나선별진료소 검색</h5>
             <div class="form-row d-flex align-items-center">
                    ...
                    <div class="form-group col-md-2">
                      <button id="searchAll" class="btn btn-info btn-lg btn-block" ><i class="fa fa-search" aria-hidden="true"></i>전체검색</button>
